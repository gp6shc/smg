<?php /* Template Name: What We Do: Advertising */ pxl::page(); while ( have_posts() ) : the_post(); ?>
...
<div class="row lined">
	...
	<div class="span6">
		...
		<!--end content-->
			...
			<div class="row lined">
				...
				<?php if (get_category(125)->category_count > 0): ?>
					...
					<p style="padding-bottom:4px;"><?php echo do_shortcode("[posts show=3 loop=post-indivcasestudy category_name=advertising]"); ?></p>
					<!--end blog section-->
				<?php endif;?>
				</div><!--end span6-->
		...
		<h3 class="whatwedo" style="font-size: 22px">Research Methods We Love</h3>
			<?php $R_query = new WP_Query( 'category_name=casestudy-advertising');
