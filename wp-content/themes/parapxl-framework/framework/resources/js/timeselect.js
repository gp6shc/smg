 ...
 * LAST UPDATED:
 * 
 * 		- jQueryDate: 2010/05/28 18:45:26 jQuery
 * 		- jQueryAuthor: paulinho4u jQuery
 * 		- jQueryRevision: 1.5 jQuery
 * 
 * 
 **********************************************************************/
		...
		function () {
			...
			if (!jQuery('#ptTimeSelectCntr').length) {
				jQuery("body").append(
					...
					+	'				<span id="ptTimeSelectUserSelHr">7</span> : '
					...
					+	'								style="display: block; width: 111px; float: left;">AM</a>'
					+	'						<a class="ptTimeSelectHr ui-state-default" href="javascript: void(0);" '
					+	'								style="display: block; width: 111px; float: right;">PM</a>'
					+	'						<br style="clear: left;" /><div></div>'
					+	'					</div>'
					+	'				</div>'
					+	'			</div>'
