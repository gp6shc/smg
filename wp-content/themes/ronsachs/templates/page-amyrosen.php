		...
		<!--end content-->
			...
			<div class="row lined">
				<div class="span6">
					...
					<?php if (get_category(122)->category_count > 0): ?>
					<!--blog section-->
